...
public class Level_14_Log_ExtentReport_V2 extends BaseTest {
...
//		ExtentTestManager.getTest().log(LogStatus.INFO, "User_01_Register - Step 02: Enter to First Name textbox");
//		registerPage.inputToFirstnameTextbox(firstName);

//		ExtentTestManager.getTest().log(LogStatus.INFO, "User_01_Register - Step 03: Enter to Last Name textbox");
//		registerPage.inputToLastnameTextbox(lastName);

//		ExtentTestManager.getTest().log(LogStatus.INFO, "User_01_Register - Step 04: Enter to Email Address textbox with value" + emailAddress);
...
//		ExtentTestManager.getTest().log(LogStatus.INFO, "User_01_Register - Step 06: Enter to Confirm Password textbox with value" + confirmPassword);
...
//		ExtentTestManager.getTest().log(LogStatus.INFO, "User_02_Login - Step 02: Input to Email Address textbox with value" + emailAddress);
//		loginPage.inputToEmailTextbox(emailAddress);

//		ExtentTestManager.getTest().log(LogStatus.INFO, "User_02_Login - Step 03: Input to Password textbox with value" + password);
