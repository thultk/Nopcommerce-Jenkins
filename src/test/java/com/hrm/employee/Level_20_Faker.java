...
public class Level_20_Faker extends BaseTest {
	String adminUserName, adminPassword, empFirstName, empLastName, empUserName, empFullName, empPassword, employeeID, statusValue;
	String avatarFilePath, editEmpFirstName, editEmpLastName, editEmpGender, editEmpMaritalStatus, editEmpNationality;
