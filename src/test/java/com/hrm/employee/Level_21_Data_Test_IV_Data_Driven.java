...
public class Level_21_Data_Test_IV_Data_Driven extends BaseTest {
	...
	public void Employee_01_Add_New_Employee() {
		...
		verifyEquals(employeeListPage.getValueDisplayedInTableIDAtColumnNameAndRowIndex(driver, "resultTable", "Last Name", "1"), employeeData.getLastname());
	}
	...
	public void Employee_02_Upload_Avatar() {
		...
		dashboardPage = loginPage.loginToSystem(driver, employeeData.getFirstname(), employeeData.getPassword());
	...
	public void Employee_03_Personal_Details() {
		...
		myInfoPage.clickToRadioByLabel(driver, employeeData.getEditGender());

		log.info("Personal_Details_03 - Step 12: Select new value to 'Marital Status' dropdown");
		myInfoPage.selectDropdownByName(driver, "personal[cmbMarital]", employeeData.getEditMartialStatus());

		log.info("Personal_Details_03 - Step 13: Select new value to 'Nationality' dropdown");
		myInfoPage.selectDropdownByName(driver, "personal[cmbNation]", employeeData.getEditNationality());
		...
		verifyEquals(myInfoPage.getTextboValueByID(driver, "personal_txtEmpFirstName"), employeeData.getEditFirstName());

		log.info("Personal_Details_03 - Step 17: Verify 'Last Name' textbox is updated successfully");
		verifyEquals(myInfoPage.getTextboValueByID(driver, "personal_txtEmpLastName"), employeeData.getEditLastName());

		log.info("Personal_Details_03 - Step 18: Verify 'Gender' radio button is updated successfully");
		verifyTrue(myInfoPage.isRadioButtonSelected(driver, employeeData.getEditGender()));

		log.info("Personal_Details_03 - Step 19: Verify 'Marital Status' dropdown is updated successfully");
		verifyEquals(myInfoPage.getSelectedValueInDropdownByID(driver, "personal_cmbMarital"), employeeData.getEditMartialStatus());
		log.info("Personal_Details_03 - Step 20: Verify 'Nationality' dropdown is updated successfully");
		verifyEquals(myInfoPage.getSelectedValueInDropdownByID(driver, "personal_cmbNation"), employeeData.getEditNationality());
