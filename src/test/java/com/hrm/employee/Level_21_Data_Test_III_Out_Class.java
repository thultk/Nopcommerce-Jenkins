...
public class Level_21_Data_Test_III_Out_Class extends BaseTest {
	...
	public void Employee_01_Add_New_Employee() {
		...
		addEmployeePage.enterToTextboxByID(driver, "firstName", Employee.EmployeeInfo.FIRSTNAME);

		log.info("Add_New_01 - Step 04: Enter valid info to 'Last Name' textbox");
		addEmployeePage.enterToTextboxByID(driver, "lastName", Employee.EmployeeInfo.LASTNAME);
		...
		addEmployeePage.enterToTextboxByID(driver, "user_name", Employee.EmployeeInfo.USERNAME);

		log.info("Add_New_01 - Step 08: Enter valid info to 'Password' textbox");
		addEmployeePage.enterToTextboxByID(driver, "user_password", Employee.EmployeeInfo.PASSWORD);

		log.info("Add_New_01 - Step 09: Enter valid info to 'Confirm Password' textbox");
		addEmployeePage.enterToTextboxByID(driver, "re_password", Employee.EmployeeInfo.PASSWORD);

		log.info("Add_New_01 - Step 10: Select '" + Employee.EmployeeInfo.STATUS_VALUE + "' value in 'Status' dropdown");
		addEmployeePage.selectDropdownByID(driver, "status", Employee.EmployeeInfo.STATUS_VALUE);
		;
		...
		employeeListPage.enterToTextboxByID(driver, "empsearch_employee_name_empName", Employee.EmployeeInfo.FULLNAME);
		verifyTrue(employeeListPage.isJQueryLoadedSuccess(driver));
		...
		verifyEquals(employeeListPage.getValueDisplayedInTableIDAtColumnNameAndRowIndex(driver, "resultTable", "Last Name", "1"), Employee.EmployeeInfo.LASTNAME);
	}

	public void Employee_02_Upload_Avatar() {
		log.info("Upload_Avatar_02 - Step 01: Login with Employee role");
		loginPage = employeeListPage.logoutToSystem(driver);
		dashboardPage = loginPage.loginToSystem(driver, Employee.EmployeeInfo.FIRSTNAME, Employee.EmployeeInfo.PASSWORD);
	...
	public void Employee_03_Personal_Details() {
		...
		myInfoPage.enterToTextboxByID(driver, "personal_txtEmpFirstName", Employee.PersonalDetail.FIRSTNAME);

		log.info("Personal_Details_03 - Step 10: Enter new value to 'Last Name' textbox");
		myInfoPage.enterToTextboxByID(driver, "personal_txtEmpLastName", Employee.PersonalDetail.LASTNAME);

		log.info("Personal_Details_03 - Step 11: Select new value to 'Gender' radio button");
		myInfoPage.clickToRadioByLabel(driver, Employee.PersonalDetail.GENDER);

		log.info("Personal_Details_03 - Step 12: Select new value to 'Marital Status' dropdown");
		myInfoPage.selectDropdownByName(driver, "personal[cmbMarital]", Employee.PersonalDetail.MARITAL_STATUS);

		log.info("Personal_Details_03 - Step 13: Select new value to 'Nationality' dropdown");
		myInfoPage.selectDropdownByName(driver, "personal[cmbNation]", Employee.PersonalDetail.NATIONALITY);
		...
		verifyEquals(myInfoPage.getTextboValueByID(driver, "personal_txtEmpFirstName"), Employee.PersonalDetail.FIRSTNAME);

		log.info("Personal_Details_03 - Step 17: Verify 'Last Name' textbox is updated successfully");
		verifyEquals(myInfoPage.getTextboValueByID(driver, "personal_txtEmpLastName"), Employee.PersonalDetail.LASTNAME);

		log.info("Personal_Details_03 - Step 18: Verify 'Gender' radio button is updated successfully");
		verifyTrue(myInfoPage.isRadioButtonSelected(driver, Employee.PersonalDetail.GENDER));
